...
public class EmailListMonth extends ArrayAdapter<String> {
    private Activity context;
    private List<String> emailList, idList;
    DatabaseReference databaseMEmails; //for only weekly emails

    public EmailListMonth(Activity context, List<String> emailList){
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addBtn.setOnClickListener(new View.OnClickListener(){
                    @Override
                    public void onClick(View view){
                        databaseMEmails.child(idList.get(position)).removeValue();
                        dialog.dismiss();
